...
public class TTLCacheTest {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        TTLCacheTest crunchifyCache = new TTLCacheTest();
    ...
    private void crunchifyTestAddRemoveObjects() {
        ...
        // maxItems = 6
        TTLCache<String, String> cache = new TTLCache<String, String>(200, 500, 6);
    ...
    private void crunchifyTestExpiredCacheObjects() throws InterruptedException {
        ...
        // maxItems = 10
        TTLCache<String, String> cache = new TTLCache<String, String>(1, 1, 10);
    ...
    private void crunchifyTestObjectsCleanupTime() throws InterruptedException {
        ...
        TTLCache<String, String> cache = new TTLCache<String, String>(100, 100, 500000);
